...
class TestRegistration:
    ...
    def test_registration_passed(self, driver_chrome):
        email = generic_email()
    ...
    def test_registration_fail_password(self, driver_chrome):
        driver = driver_chrome
        driver.get('https://stellarburgers.nomoreparties.site/')
        ...
        error = driver.find_element(*Locators.INVALID_PASSWORD_TEXT).text
